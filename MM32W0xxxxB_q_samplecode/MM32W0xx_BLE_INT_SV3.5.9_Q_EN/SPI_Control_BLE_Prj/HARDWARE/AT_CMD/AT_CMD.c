...
**          
**@param    parameter £ºParameter whose name needs to be modified
**
...
**          
**@param    parameter £ºParameter whose interval needs to be modified
**
**@param    len £ºData length
**
**@return   None.
...
**          
**@param    parameter £ºData to be sent
**
**@param    len £ºData length
**
**@return   None.
...
**          
**@param    parameter £ºReceived data
**
**@param    len £ºData length
**
**@return   None.
...
**          
**@param    data £ºData to be processed
**
**@param    cmd  £ºCommand data
**
**@return   None.
********************************************************************************************************/
...
**          
**@param    cmd £ºData to be processed
**
**@param    len £ºData length
**
**@return   None.
