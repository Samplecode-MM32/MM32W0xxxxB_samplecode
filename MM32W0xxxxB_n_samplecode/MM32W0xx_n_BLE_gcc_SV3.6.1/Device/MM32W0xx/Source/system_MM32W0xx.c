...
void SetSysClockTo24_HSI()
{
    ...
    RCC->CR &=~(0x1f<<26);	
    RCC->CR|=(2 - 1) << 26;   //����PLLֵ 2~16
    
    FLASH->ACR=FLASH_ACR_PRFTBE;	  //FLASH 0����ʱ����
...
void SetSysClockTo36_HSI()
{
    ...
    RCC->CR &=~(0x1f<<26);	
    RCC->CR|=(3 - 1) << 26;   //����PLLֵ 2~16
    
    FLASH->ACR=FLASH_ACR_LATENCY_1|FLASH_ACR_PRFTBE;	  //FLASH 1����ʱ����
