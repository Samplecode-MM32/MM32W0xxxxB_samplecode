...
/********************************************************************************************************
**function: CRC16
**@brief    This function is a CRC check function
**
**@param    Buf     :   Storage address of data to be verified
**
**@param    BufLen  :   Data length
**
**@param    sCRC    :   Initial value of CRC
**
**@return   sCRC		: 	CRC check value
********************************************************************************************************/
...
/********************************************************************************************************
**function: ClearBank
**@brief    This function is Clear code area
**
**@param    BANK_ID_Flag     :  Code area selection
**
**@return   None.
